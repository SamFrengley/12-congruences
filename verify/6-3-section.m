...
function DoubleCoverOfConicToGenusOneModel(Cplus, r : Bound:=3)
...
// -------------------------------------
// Check the tables in Section 6.3
// -------------------------------------
...
for example in table6 do
    ...
    if g eq 0 and irred then
        ...
        if Genus(Cplus) eq 1 then
            ...
            C := DoubleCoverOfConicToGenusOneModel(Cplus, 5);
...
for example in table7 do
    ...
    if g eq 0 and irred then
        ...
        C := DoubleCoverOfConicToGenusOneModel(Cplus, 7);
...
for example in table8 do
    ...
    if g eq 0 then
        ...
        C := DoubleCoverOfConicToGenusOneModel(Cplus, 11);
